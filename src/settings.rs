...
pub struct Settings {
    ...
    pub vrchat_osc_reset_after_enabled: bool,
    pub vrchat_osc_reset_after_seconds: u16,
...
struct RawSettings {
    ...
    vrchat_osc_reset_after_enabled: bool,
    vrchat_osc_reset_after_seconds: u16,
...
impl Default for Settings {
    fn default() -> Self {
        Self {
            ...
            vrchat_osc_history_count: 1,
            vrchat_osc_use_newlines: false,
            vrchat_osc_reset_after_enabled: false,
            vrchat_osc_reset_after_seconds: 25,
...
impl Default for RawSettings {
    fn default() -> Self {
        ...
        Self {
            ...
            vrchat_osc_reset_after_enabled: defaults.vrchat_osc_reset_after_enabled,
            vrchat_osc_reset_after_seconds: defaults.vrchat_osc_reset_after_seconds,
            tts_mode: None,
            use_remote_tts: None,
...
impl<'de> Deserialize<'de> for Settings {
        ...
        D: Deserializer<'de>,
    {
        ...
        Ok(Self {
            ...
            vrchat_osc_reset_after_enabled: raw.vrchat_osc_reset_after_enabled,
            vrchat_osc_reset_after_seconds: raw.vrchat_osc_reset_after_seconds,
